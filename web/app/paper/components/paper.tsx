  ...
  return (
    <Layout className="h-full w-full justify-start">
      <div className="flex min-h-[80vh] w-full items-start justify-center py-10">
        <main className="flex w-full xl:flex-row flex-col items-start justify-center gap-x-44 gap-y-10 text-lg font-light px-6 tracking-tighter md:max-w-7xl md:justify-start">
